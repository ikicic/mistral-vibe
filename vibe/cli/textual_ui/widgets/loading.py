...
class LoadingWidget(SpinnerMixin, Static):
    ...
    def _update_hint(self, elapsed: int) -> None:
        ...
        # Only relayout when the width changes (e.g. 9s -> 10s).
        # Note that this assumes that the line that never wraps. For wrapped
        # text, equal width would not imply equal rendered size.
